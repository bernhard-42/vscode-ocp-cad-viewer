    ...
    def test_load(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                "/Group/Solid/vertices/vertices_0",
                "/Group/Solid/vertices/vertices_1",
                "/Group/Solid/vertices/vertices_2",
                "/Group/Solid/vertices/vertices_3",
                "/Group/Solid/vertices/vertices_4",
                "/Group/Solid/vertices/vertices_5",
                "/Group/Solid/vertices/vertices_6",
                "/Group/Solid/vertices/vertices_7",
            ],
        )
        self.assertEqual(
